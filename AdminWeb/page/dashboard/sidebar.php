<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.php">
        ...
        <div class="sidebar-brand-text mx-3">SINAR <sup>HARAPAN</sup></div>
    </a>
    ...
    <li class="nav-item active">
        <a class="nav-link" href="index.php?page=main-content">
    ...
    <!-- Heading -->
    <div class="sidebar-heading">UMKM Store</div>
    ...
    <li class="nav-item">
        ...
        <div id="collapseProduk" class="collapse" aria-labelledby="headingProduk" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                <h6 class="collapse-header">Belanja:</h6>
                <a class="collapse-item" href="index.php?page=list">Daftar Produk</a>
            </div>
        </div>
    </li>
